...
public interface ISupermarketRegistrationService
{
    ...
    Task<ApiResponse<MySupermarketApplicationDto>> UpdateApplicationAsync(Guid vendorUserId, Guid supermarketId, UpdateSupermarketApplicationRequest request, CancellationToken cancellationToken = default);
