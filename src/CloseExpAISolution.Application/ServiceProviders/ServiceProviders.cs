...
namespace CloseExpAISolution.Application.ServiceProviders
{
    public class ServiceProviders : IServiceProviders
    {
        ...
        public IProductImageService ProductImageService => _productImageService ??= ActivatorUtilities.CreateInstance<ProductImageService>(_serviceProvider);
        ...
        public IPromotionService PromotionService => _promotionService ??= ActivatorUtilities.CreateInstance<PromotionService>(_serviceProvider);
