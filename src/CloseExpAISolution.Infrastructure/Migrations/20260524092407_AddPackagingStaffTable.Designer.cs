...
namespace CloseExpAISolution.Infrastructure.Migrations
{
    ...
    [Migration("20260524092407_AddPackagingStaffTable")]
    partial class AddPackagingStaffTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloseExpAISolution.Domain.Entities.MarketPrice", b =>
                {
                    ...
                    b.HasIndex("Barcode", "CollectedAt");

                    b.HasIndex("Barcode", "Source", "StoreName", "CollectedAt");
            ...
            modelBuilder.Entity("CloseExpAISolution.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<string>("PackagingFailedReason")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
            ...
            modelBuilder.Entity("CloseExpAISolution.Domain.Entities.PackagingStaff", b =>
                {
                    b.Property<Guid>("PackagingStaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CloseExpAISolution.Domain.Entities.Refund", b =>
                {
                    ...
                    b.Property<string>("RefundedOrderItemIdsJson")
                        .HasMaxLength(8000)
            ...
            modelBuilder.Entity("CloseExpAISolution.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("CloseExpAISolution.Domain.Entities.UnitOfMeasure", "PurchaseUnit")
                        .WithMany()
